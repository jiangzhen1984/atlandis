...
function localStorageSupport() {
	try {
   	 	return "localStorage" in window && null !== window.localStorage && !!window.localStorage;
	} catch(e) {
...
$(function() {
    ...
    if ($("#fixednavbar").click(function() {
        $("#fixednavbar").is(":checked") ? ($(".navbar-static-top").removeClass("navbar-static-top").addClass("navbar-fixed-top"), $("body").removeClass("boxed-layout"), $("body").addClass("fixed-nav"), $("#boxedlayout").prop("checked", !1), ls.setItem("boxedlayout", "off"), ls.setItem("fixednavbar", "on")) : ($(".navbar-fixed-top").removeClass("navbar-fixed-top").addClass("navbar-static-top"), $("body").removeClass("fixed-nav"), ls.setItem("fixednavbar", "off"))
    }), $("#collapsemenu").click(function() {
        $("#collapsemenu").is(":checked") ? ($("body").addClass("mini-navbar"), SmoothlyMenu(), ls.setItem("collapse_menu", "on")) : ($("body").removeClass("mini-navbar"), SmoothlyMenu(), ls.setItem("collapse_menu", "off"))
    }), $("#boxedlayout").click(function() {
        $("#boxedlayout").is(":checked") ? ($("body").addClass("boxed-layout"), $("#fixednavbar").prop("checked", !1), $(".navbar-fixed-top").removeClass("navbar-fixed-top").addClass("navbar-static-top"), $("body").removeClass("fixed-nav"), ls.setItem("fixednavbar", "off"), ls.setItem("boxedlayout", "on")) : ($("body").removeClass("boxed-layout"), ls.setItem("boxedlayout", "off"))
        ...
        var e = ls.getItem("collapse_menu"),
        a = ls.getItem("fixednavbar"),
        o = ls.getItem("boxedlayout");
